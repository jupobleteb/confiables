...
class CategoriasControllerTest < ActionController::TestCase
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post :create, categoria: { categoria_id: @categoria.categoria_id, descripcion: @categoria.descripcion, laboral_id: @categoria.laboral_id, nombre: @categoria.nombre }
    end
  ...
  test "should update categoria" do
    patch :update, id: @categoria, categoria: { categoria_id: @categoria.categoria_id, descripcion: @categoria.descripcion, laboral_id: @categoria.laboral_id, nombre: @categoria.nombre }
    assert_redirected_to categoria_path(assigns(:categoria))
  end
