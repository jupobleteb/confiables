...
class PermisosControllerTest < ActionController::TestCase
  ...
  test "should create permiso" do
    assert_difference('Permiso.count') do
      post :create, permiso: { descripcion: @permiso.descripcion, perfil_id: @permiso.perfil_id, permisos_id: @permiso.permisos_id, tipo: @permiso.tipo }
    end
  ...
  test "should update permiso" do
    patch :update, id: @permiso, permiso: { descripcion: @permiso.descripcion, perfil_id: @permiso.perfil_id, permisos_id: @permiso.permisos_id, tipo: @permiso.tipo }
    assert_redirected_to permiso_path(assigns(:permiso))
  end
