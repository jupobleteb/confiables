...
class TelefonosControllerTest < ActionController::TestCase
  ...
  test "should create telefono" do
    assert_difference('Telefono.count') do
      post :create, telefono: { codciudad: @telefono.codciudad, codpais: @telefono.codpais, numero: @telefono.numero, telefono_id: @telefono.telefono_id }
    end
  ...
  test "should update telefono" do
    patch :update, id: @telefono, telefono: { codciudad: @telefono.codciudad, codpais: @telefono.codpais, numero: @telefono.numero, telefono_id: @telefono.telefono_id }
    assert_redirected_to telefono_path(assigns(:telefono))
  end
