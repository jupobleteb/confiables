...
class SociosControllerTest < ActionController::TestCase
  ...
  test "should create socio" do
    assert_difference('Socio.count') do
      post :create, socio: { cargo: @socio.cargo, descripcion: @socio.descripcion, socio_id: @socio.socio_id, usuario_id: @socio.usuario_id }
    end
  ...
  test "should update socio" do
    patch :update, id: @socio, socio: { cargo: @socio.cargo, descripcion: @socio.descripcion, socio_id: @socio.socio_id, usuario_id: @socio.usuario_id }
    assert_redirected_to socio_path(assigns(:socio))
  end
