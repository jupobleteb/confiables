class DireccionesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @direccion.save
        format.html { redirect_to @direccion, notice: 'Direccion fue exitosamente creado.' }
  ...
  def update
    respond_to do |format|
      if @direccion.update(direccion_params)
        format.html { redirect_to @direccion, notice: 'Direccion  fue exitosamente actualizado.' }
  ...
  def destroy
    @direccion.destroy
    respond_to do |format|
      format.html { redirect_to direcciones_url, notice: 'Direccion fue exitosamente destruido.' }
  ...
  private
    ...
    def direccion_params
      params.require(:direccion).permit(:direccion_id, :direccion, :numero, :complemento, :codPostal, :comuna_id)
    end
end
