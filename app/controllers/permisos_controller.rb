class PermisosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @permiso.save
        format.html { redirect_to @permiso, notice: 'Permiso fue exitosamente creado.' }
  ...
  def update
    respond_to do |format|
      if @permiso.update(permiso_params)
        format.html { redirect_to @permiso, notice: 'Permiso  fue exitosamente actualizado.' }
  ...
  def destroy
    @permiso.destroy
    respond_to do |format|
      format.html { redirect_to permisos_url, notice: 'Permiso fue exitosamente destruido.' }
  ...
  private
    ...
    def permiso_params
      params.require(:permiso).permit(:permisos_id, :tipo, :descripcion, :perfil_id)
    end
end
