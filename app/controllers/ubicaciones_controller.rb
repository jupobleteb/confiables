class UbicacionesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ubicacion.save
        format.html { redirect_to @ubicacion, notice: 'Ubicacion fue exitosamente creado.' }
  ...
  def update
    respond_to do |format|
      if @ubicacion.update(ubicacion_params)
        format.html { redirect_to @ubicacion, notice: 'Ubicacion  fue exitosamente actualizado.' }
  ...
  def destroy
    @ubicacion.destroy
    respond_to do |format|
      format.html { redirect_to ubicaciones_url, notice: 'Ubicacion fue exitosamente destruido.' }
  ...
  private
    ...
    def ubicacion_params
      params.require(:ubicacion).permit(:ubicacion_id, :longitud, :latitud, :fecha, :usuario_id)
    end
end
