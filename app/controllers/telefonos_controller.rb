class TelefonosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @telefono.save
        format.html { redirect_to @telefono, notice: 'Telefono fue exitosamente creado.' }
  ...
  def update
    respond_to do |format|
      if @telefono.update(telefono_params)
        format.html { redirect_to @telefono, notice: 'Telefono  fue exitosamente actualizado.' }
  ...
  def destroy
    @telefono.destroy
    respond_to do |format|
      format.html { redirect_to telefonos_url, notice: 'Telefono fue exitosamente destruido.' }
  ...
  private
    ...
    def telefono_params
      params.require(:telefono).permit(:telefono_id, :codpais, :codciudad, :numero)
    end
end
