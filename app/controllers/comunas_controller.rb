class ComunasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comuna.save
        format.html { redirect_to @comuna, notice: 'Comuna fue exitosamente creado.' }
  ...
  def update
    respond_to do |format|
      if @comuna.update(comuna_params)
        format.html { redirect_to @comuna, notice: 'Comuna  fue exitosamente actualizado.' }
  ...
  def destroy
    @comuna.destroy
    respond_to do |format|
      format.html { redirect_to comunas_url, notice: 'Comuna fue exitosamente destruido.' }
  ...
  private
    ...
    def comuna_params
      params.require(:comuna).permit(:comuna_id, :nombre, :region, :pais)
    end
end
