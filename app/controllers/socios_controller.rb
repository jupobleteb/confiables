class SociosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @socio.save
        format.html { redirect_to @socio, notice: 'Socio fue exitosamente creado.' }
  ...
  def update
    respond_to do |format|
      if @socio.update(socio_params)
        format.html { redirect_to @socio, notice: 'Socio  fue exitosamente actualizado.' }
  ...
  def destroy
    @socio.destroy
    respond_to do |format|
      format.html { redirect_to socios_url, notice: 'Socio fue exitosamente destruido.' }
  ...
  private
    ...
    def socio_params
      params.require(:socio).permit(:socio_id, :cargo, :descripcion, :usuario_id)
    end
end
